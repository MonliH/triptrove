...
async def hotels(body: HotelRequest):
    async with httpx.AsyncClient() as client:
        res = await client.post(
            ...
            json={"operationName":"FullSearch","variables":{"input":{"acidCarouselContext":None,"childrenAges":[],"dates":{"checkin":body.departDate,"checkout":body.returnDate},"doAvailabilityCheck":False,"encodedAutocompleteMeta":None,"enableCampaigns":True,"filters":{"selectedFilters":f"price=CAD-min-{body.maxPrice}-1"},"forcedBlocks":None,"location":{"searchString":body.cityName,"destType":"CITY","destId":body.ufi},"metaContext":{"metaCampaignId":0,"externalTotalPrice":None,"feedPrice":None,"rateRuleId":None,"dragongateTraceId":None},"nbRooms":1,"nbAdults":2,"nbChildren":0,"showAparthotelAsHotel":True,"needsRoomsMatch":False,"optionalFeatures":{"forceArpExperiments":True,"testProperties":False},"pagination":{"rowsPerPage":25,"offset":0},"rawQueryForSession":"/searchresults.html?label=gen173nr-1BCAEoggI46AdIM1gEaCeIAQGYATG4AQfIAQzYAQHoAQGIAgGoAgO4ArCj2aQGwAIB0gIkODI5YmM1N2UtY2VkYS00NTczLTljZGYtNGY4NDhhN2RmY2Mw2AIF4AIB&aid=304142&ss=Toronto&ssne=Toronto&ssne_untouched=Toronto&lang=en-us&src=searchresults&dest_id=-574890&dest_type=city&checkin=2023-07-04&checkout=2023-07-19&group_adults=2&no_rooms=1&group_children=0&nflt=price%3DCAD-min-700-1","referrerBlock":None,"sorters":{"selectedSorter":None,"referenceGeoId":None,"tripTypeIntentId":None},"travelPurpose":2,"seoThemeIds":[],"useSearchParamsFromSession":True},"geniusVipUI":{"enableEnroll":True,"page":"SEARCH_RESULTS"}},"extensions":{},"query":HOTEL_QUERY},
            headers={
                "Accept": "*/*",
